...
//TODO Die Kamera-Steuerung muss sich einstellen lassen

/**
 * Die Klasse CameraControlPlugin ist ein Plugin fuer die Engine
 * Es ermoeglicht eine Kamerasteuerung beliebiger Szenen
 * 
 * @version 0.1 pre-alpha, 2013-02-21
 * @author Uwe Wilko Gruenefeld
 */
public class CameraControlPlugin extends Plugin
{
	/*
	 * Tastatur und Maus
	 */
	 ...
	 * @param engine
	 */
	public CameraControlPlugin( DiamondEngine engine )
	{
		super( engine );
		...
		engine.getCanvas().addMouseListener( this.mouse );
		engine.getCanvas().addMouseMotionListener( this.mouse );
		engine.getCanvas().addMouseWheelListener( this.mouse );
	}
