...
/**
 * Die Klasse VertexShader repraesentiert Vertex Shader in OpenGL
 * 
...
public class VertexShader extends AbstractShader 
{
	 ...
	 */
	public VertexShader( InputStream stream )
	{
		super( stream );
	}
	...
	boolean compile( GL2 gl ) 
	{
		...
		if( this.create )
		{
			this.setShaderID( gl.glCreateShader( GL2.GL_VERTEX_SHADER ));
			this.create = false;
		}		
